...
export class TextSplitter {
  ...
  constructor(textElement, options = {}) {
    // Ensure the textElement is a valid HTMLElement and SplitType is available
    if (!textElement || !(textElement instanceof HTMLElement)) {
      throw new Error('Invalid text element provided.');
    }
    
    if (!SplitType) {
      console.error('SplitType is not available. Make sure split-type.min.js is loaded before this script.');
      return;
    }
